      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-8">
          <div className="text-left max-w-2xl">
            ...
            <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight">
              Icons of the{" "}
              <span className="bg-gradient-to-r from-[#7c3aed] to-[#f97316] bg-clip-text text-transparent">Global Map</span>
            </h2>
          ...
          <div className="hidden md:flex gap-4">
            ...
            <button
              ...
              className="w-14 h-14 rounded-2xl bg-slate-900 text-white flex items-center justify-center hover:bg-[#7c3aed] transition-all group shadow-lg"
        ...
        <div className="text-center mt-4">
          <button
            ...
            className="px-8 py-4 bg-gradient-to-r from-[#7c3aed] to-[#f97316] text-white rounded-2xl font-bold text-xs uppercase tracking-widest shadow-lg hover:opacity-90 transition-all group"
          >
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-8 left-8 flex flex-col gap-3">
        ...
        {/* Rating — brand red */}
        <div className="bg-[#f97316] px-3 py-1.5 rounded-xl flex items-center gap-1.5 w-fit shadow-lg">
      ...
      <div className="absolute bottom-8 left-8 right-8 text-white">
        ...
        <div className="flex items-center gap-6 border-t border-white/10 pt-6">
          ...
          <div className="group/btn ml-auto w-12 h-12 bg-white rounded-2xl flex items-center justify-center text-slate-900 group-hover:bg-[#7c3aed] group-hover:text-white transition-all duration-300 shadow-lg">
            <ArrowRight
              size={20}
