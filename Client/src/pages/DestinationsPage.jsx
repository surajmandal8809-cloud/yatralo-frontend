    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <section className="relative h-[80vh] min-h-[520px] flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-indigo-900/30 via-transparent to-rose-900/20" />
                ...
                <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col md:flex-row items-center gap-4">
                    ...
                    <div className="relative w-full md:max-w-xs">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm font-semibold text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition"
                        />
                    </div>
                    ...
                    <div className="flex gap-2 overflow-x-auto scrollbar-none pb-0.5 w-full md:w-auto">
                        {CATEGORIES.map((cat) => (
                            <button
                                ...
                                className={`flex-shrink-0 flex items-center gap-1.5 px-4 py-2.5 rounded-2xl text-xs font-black uppercase tracking-wide transition-all ${activeCategory === cat.id
