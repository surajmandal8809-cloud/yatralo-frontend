    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 pt-24 pb-20 overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 pt-16 mb-16 relative">
                <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-64 h-64 bg-orange-100 rounded-full blur-3xl opacity-50 -z-10" />
                <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 w-48 h-48 bg-indigo-100 rounded-full blur-3xl opacity-50 -z-10" />
