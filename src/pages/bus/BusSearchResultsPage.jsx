          ...
          <div className="fixed inset-0 z-[60] flex flex-col md:hidden">
            ...
            <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }} transition={{ type: "spring", damping: 25, stiffness: 300 }} className="relative mt-auto bg-white rounded-t-[2.5rem] p-6 pb-10">
               ...
               <div className="space-y-6">
                  ...
                  <button type="button" onClick={() => navigate("/buses")} className="w-full h-16 bg-gradient-to-r from-[#7c3aed] to-[#f97316] text-white rounded-2xl text-sm font-black uppercase tracking-[0.2em] shadow-xl shadow-violet-100 mt-4">Redefine Route</button>
               </div>
            </motion.div>
          </div>
        )}
