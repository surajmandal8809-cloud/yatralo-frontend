      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-8 sm:p-10">
        ...
        <div className="text-center">
          ...
          <p className="mt-3 text-sm text-gray-500 leading-relaxed">
            We sent you a six digit code to confirm your account.
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full rounded-xl bg-[#cf3425] hover:bg-[#b82e1f] py-3 text-white font-semibold text-sm uppercase tracking-wide shadow-lg transition disabled:opacity-60"
          >
