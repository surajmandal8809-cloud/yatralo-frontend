...
import { Calendar, CircleDot, Plane, Search, Ticket, Train } from "lucide-react";
import { formatInr, getBookings } from "../utils/bookingStore";
    ...
    <div className="min-h-screen bg-slate-50 pt-28 pb-16">
      <section className="max-w-6xl mx-auto px-6">
        <div className="rounded-3xl bg-gradient-to-r from-slate-900 via-slate-800 to-slate-700 text-white p-7 md:p-10 shadow-xl">
          <p className="text-[11px] tracking-[0.28em] uppercase text-white/70 font-black">Booking Center</p>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
            <p className="text-[11px] uppercase tracking-widest text-slate-400 font-black">Total Spent</p>
            <p className="text-3xl font-black text-slate-900 mt-2">{formatInr(totalSpent)}</p>
          </div>
          <div className="bg-white border border-slate-200 rounded-2xl p-4 shadow-sm">
            <p className="text-[11px] uppercase tracking-widest text-slate-400 font-black">Latest Reference</p>
              ...
              >
                ...
                <div className="p-5">
                  <div className="flex flex-wrap items-start justify-between gap-4">
                    <div>
                      <div className={`inline-flex items-center gap-1.5 border px-2.5 py-1 rounded-full text-[11px] font-black uppercase ${style.badge}`}>
                        <Icon size={11} />
                        {booking.type}
                      </div>
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm font-semibold text-emerald-600 capitalize">{booking.status}</p>
                    </div>
                  </div>
