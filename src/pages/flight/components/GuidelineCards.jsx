    ...
    const guidelines = [
        {
            ...
            desc: "Updated state-wise & international guidelines",
            icon: ShieldCheck,
            color: "text-blue-600",
            bg: "bg-blue-50",
        ...
        {
            title: "Web Check-in",
            desc: "Don't wait in queues, check-in online for free",
            icon: CalendarCheck,
            color: "text-[#7c3aed]",
            bg: "bg-indigo-50",
            link: "/web-checkin"
        ...
        {
            title: "My Safety",
            desc: "Ensuring health & safety for all travels",
            icon: Sparkles,
        ...
        {
            title: "24/7 Support",
            desc: "Always here for all your travel needs",
            icon: PhoneCall,
